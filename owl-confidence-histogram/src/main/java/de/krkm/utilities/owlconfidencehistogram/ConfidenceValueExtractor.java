...
public class ConfidenceValueExtractor {
    ...
    /**
     * Initialize the internal list of annotated axioms contained in the ontology
     * given by <code>in</code>. Only axioms having one of the annotation properties
     * contained in <code>properties</code> are considered. The confidence value is
     * taken from the first property in this list which exists for the specific
     * axiom.
     *
     ...
     */
    public ConfidenceValueExtractor(InputStream in, ArrayList<OWLAnnotationProperty> properties) throws OWLOntologyCreationException {
